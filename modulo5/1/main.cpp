...
void rotacao(int angle) {
    ...
    /**/
    glClear(GL_COLOR_BUFFER_BIT);
    glTranslated(  screenHeight/2, screenHeight/2, 0  );
    glRotated(  (double) angle, 0, 0, 1  );
    glTranslated(  -(screenHeight/2), -(screenHeight/2), 0  );
    /**/
...
int main(int argc, char** argv)
{
    ...
    cout << "[m] - Move o ponto para a próxima localização" << endl;
    cout << "[d] - Limpa a tela e redesenha todos os polígonos" << endl;
    cout << "[q] - Termina o programa" << endl;
    cout << "[s] - Salva os polígonos em um arquivo" << endl;
    cout << "[l] - Carrega o arquivo" << endl << endl;
    cout << "[T] - Ativa a translação" << endl;
    cout << "[E] - Ativa a Escala" << endl;
    cout << "[R] - Ativa a Rotação" << endl;
    cout << "[UP] - Rotaciona, translada para cima ou aumenta escala" << endl;
    cout << "[DOWN] - Translada para baixo ou diminui escala" << endl;
    cout << "[LEFT] - Translada para a esquerda" << endl;
    cout << "[RIGHT] - Translada pra a direita" << endl;
