...
ImageClass EqualizaHistograma(ImageClass *imageIn)
{
	if ( Imagem2 != NULL ) delete Imagem2;
    Imagem2 = new ImageClass ( Imagem1 -> SizeX(), Imagem1 -> SizeY() );
    Imagem2 -> SetPos ( Imagem1 -> SizeX()+10, 0 );
...
int main ( int argc, char** argv )
{
	...
	cout << " 4 - equalizar histograma (a partir de imagem em escala de cinza)" << endl;
